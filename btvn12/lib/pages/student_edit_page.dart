...
class StudentEditPage extends StatelessWidget {
  ...
  String address;
  String phone;
  StudentEditPage({Key? key,required this.id,required this.name,required this.address, required this.phone}) : super(key: key);
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                phone = _phone.text;
                homeState.sqLiteController.updateStudent(Student(id: id,name: name, address: address, phone: phone));
              },
              child: BigText(text: 'Lưu',size: 18,color: Colors.white,),
